...
function FloatingOrb() {
  ...
  return (
    <Float speed={1.8} rotationIntensity={0.4} floatIntensity={0.8}>
      ...
      <pointLight color="#a855f7" intensity={2} distance={4} position={[2, -1, 0]} />
    </Float>
  )
}
...
/* ── Typing effect ────────────────────────────────────────── */
const ROLES = ['MERN Full-Stack Developer', 'React Specialist', 'Backend Engineer', 'API Architect']
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 w-full pt-24">
        ...
        >
          ...
          <motion.h1
            variants={item}
            className="text-5xl sm:text-6xl lg:text-7xl font-black leading-[1.05] tracking-tight text-white mb-4"
          >
            Bhavani
            <br />
          ...
          {/* Typed role */}
          <motion.div variants={item} className="text-xl sm:text-2xl font-medium text-slate-300 mb-6 h-8">
            <TypedText />
          </motion.div>
          ...
          >
            MERN Full-Stack Developer crafting responsive, user-centric applications — from
            React UIs to Node.js APIs — with a focus on scalability and clean architecture.
          </motion.p>
          ...
          <motion.div variants={item} className="flex items-center gap-5">
            ...
            <span className="text-xs font-mono text-slate-600 tracking-widest">bhavanishankarmandala@gmail.com</span>
          </motion.div>
        </motion.div>
      </div>
